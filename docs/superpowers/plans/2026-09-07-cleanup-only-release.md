...
- Preserve complete paragraphs and timestamp occurrences in order. Reject incomplete/length-limited/blank model responses. Bisect only completed but invalid cleanup, not generation errors.
